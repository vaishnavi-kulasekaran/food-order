...
<br/> <br/> <br/>          
             ...
             ?>                  
             <table class="tbl-full fonts-sizes">
                 <tr>
                     <th>S.No</th>
                     <th>Title</th>
                     <th>Description</th>
                         ...
                         if($count > 0)
                         {
                             ...
                             while($rows=mysqli_fetch_assoc($res))
                             {
                                 ...
                                 <tr>
                                     ...
                                     <td>
                                        <a href="<?php echo SITEURL; ?>admin/update-food.php?id=<?php echo $id; ?>&image_name=<?php echo $image_name; ?>" class="btn-secondary">Update</a><br><br><br>
                                        <a href="<?php echo SITEURL; ?>admin/delete-food.php?id=<?php echo $id; ?>&image_name=<?php echo $image_name; ?>" class="btn-danger tab-space" >Delete</a>
                                     </td> 
                                 </tr>
                                 <?php
                             }
